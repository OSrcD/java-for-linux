<template>
	<div class="error-page">
		...
		<template v-if="token">
			...
			<div class="link">
				<el-link href="#" class="to-home" @click="home">回到首页</el-link>
				<el-link href="#" class="to-back" @click="back">返回上一页</el-link>
				<el-link href="#" class="to-login" @click="login">重新登录</el-link>
			</div>
		</template>
