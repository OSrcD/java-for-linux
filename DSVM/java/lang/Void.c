...
static clsField class_fields[] = {
	{&clsJAVA_LANG_VOID, ACC_PUBLIC | ACC_STATIC | ACC_FINAL, "TYPE", "Ljava/lang/Class;", 0x5a59a239, 0, NULL, 
...
void JNICALL Java_java_lang_Void_clinit(JNIEnv *env, jclass clazz);
static clsMethod Java_java_lang_Void_clinitID = {&clsJAVA_LANG_VOID, ACC_PRIVATE|ACC_STATIC|ACC_NATIVE, "<clinit>", "()V",
	   0x8C1695DC, 0, Java_java_lang_Void_clinit, 0, 10, 0, NULL, /* VM internal affairs */ 0, 0, 'V'};
static void JNICALL Java_java_lang_Void_clinit(JNIEnv *env, jclass clazz) {
	clsField *class_fields = VM_CLASS_DEF(clazz)->class_fields;
	class_fields[0].val.l = JNINEWGLOBALREF(env, jniFindClass(env, clsVOID.name));  /* TYPE */
}

static clsMethod* class_methods[] = {
	&Java_java_lang_Void_clinitID
};
...
clsDefinition clsJAVA_LANG_VOID = {
