...
//
//        // 将我改成上面生成的token!!!
//        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1OTM0OTI2NTgsImV4cCI6MTU5NDcwMjI1OH0.-oEkssOIhUGXpafGJkr-YE42V74xGD4m97SK6Ydz-hk";
...
//        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE1OTM0OTI4MjcsImV4cCI6MTU5NDcwMjQyN30";
//        // 测试5: 解密Payload
//        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
//        System.out.println(new String(payload));
//
//        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
//        jwtOperator.validateToken("eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1OTM0OTI4ODEsImV4cCI6MTU5NDcwMjQ4MX0.huJOvlGNP9NxM1kaPOKkW69pKIl-3XoerOgw09JaMLY");
    }
}
