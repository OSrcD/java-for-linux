<template>
	<div class="perf-redis">
			...
			<el-col :span="8">
				<div class="block">
					...
					<ul class="b">
						<li>
							<p>输入</p>
							<p>{{ unit_size(total_net_input_bytes) }}</p>
						</li>
						<li>
							<p>输出</p>
							<p>{{ unit_size(total_net_output_bytes) }}</p>
						</li>
					</ul>
				</div>
			</el-col>
		...
		<e-charts ref="chart" :option="chart.options" autoresize></e-charts>
	</div>
</template>
