          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
              <ul class="list-inline top-link link">
                <li><router-link to="/index"><i class="fa fa-home"></i> Home</router-link></li>
                <li><router-link to="/contact"><i class="fa fa-comments"></i> Contact</router-link></li>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
              ...
              <li><router-link to="/archive"><i class="fa fa-cubes"></i> Blocks</router-link></li>
              <li><router-link to="/contact"><i class="fa fa-envelope"></i> Contact</router-link></li>
            </ul>
          </div>
        </div>
      </nav>
